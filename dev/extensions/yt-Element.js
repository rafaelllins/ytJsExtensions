...
criado: 01/10/2011
�ltima modifica��o: 27/07/2012
*****************************************/

/*************************************************************************************************************************************************
TASK:
[ ]  -  Realizar um comporativo de desempenho entre as implementa��es das duas fun��es (getGroupsElementsByAttributes e getElementsByAttributes) com uma equival�ncia em jQuery.
[ ]  -  Melhorar o c�digo de exemplo.
**************************************************************************************************************************************************/

/*********************************************************************************************
searchElements: -> Grupo de elementos a serem pesquisados.
[{	
	groupName -> obrigat�rio, nome do atributo (grupo) que conter� o objeto, caso encontrado. Se a op��o single estiver falsa, ser� retornado um array.
	single -> opcional, retorna na primeira ocorr�ncia, default � falso
	att:{ -> Qualquer atributo e em quantos quiser. Obrigat�rio ao menos um atributo.
		id,
		className,
		tagName,
		value,
...
}, ...] -> mais de uma express�o de busca pode ser passada ao m�todo e todas ser�o verificadas em conjunto
,settings: -> Configura��es gerais. Opcional.
{
	ignoreCase -> opcional, compara��o case insensitive
	...
	if(searchElements != undefined && typeof searchElements == "object" && searchElements.length > 0){
		for(var z = 0; z < searchElements.length && typeof searchElements[z] == "object"; z++){
			...
			if(validGroupName && validAtt){
				...
				//Verifica se possui uma express�o de busca
		...
		if(arrElementsExpression.length > 0){
			...
			//Compila a rotina de verifica��o e adi��o de novos elementos
...
/*********************************************************************************************
attributes:{ -> Qualquer atributo e em quantos quiser. Obrigat�rio ao menos um atributo
	id,
	className,
	tagName,
	value,
...
settings:{ -> Configura��es. Opcional.
	single -> Retorna na primeira ocorr�ncia. Opcional.
	ignoreCase -> Compara��o case insensitive. Opcional.
